...
class Sparsity(SharedObject, SparsityInterfaceCommon, PrintableCommon):
    ...
    def qr_sparse(self, *args):
        """
          ...
          qr_sparse(self) -> (Sparsity OUTPUT, Sparsity OUTPUT, [int] OUTPUT, [int] OUTPUT, [int] OUTPUT)
    ...
    def symbfact(self, *args):
        """
          Symbolic factorization analysis See Direct Methods for Sparse Linear Systems

          symbfact(self, bool ata) -> ([int] OUTPUT, [int] OUTPUT, [int] OUTPUT, Sparsity OUTPUT)
        ...
        """
        return _casadi.Sparsity_symbfact(self, *args)
...
def qr_sparse(*args):
    ...
    qr_sparse(IM A) -> (IM OUTPUT1, IM OUTPUT2, IM OUTPUT3, [int] OUTPUT4)
    qr_sparse(DM A) -> (DM OUTPUT1, DM OUTPUT2, DM OUTPUT3, [int] OUTPUT4)
    qr_sparse(SX A) -> (SX OUTPUT1, SX OUTPUT2, SX OUTPUT3, [int] OUTPUT4)
...
def qr_solve(*args):
    ...
    qr_solve(IM b, IM v, IM r, IM beta, [int] pinv, bool tr) -> IM
    qr_solve(DM b, DM v, DM r, DM beta, [int] pinv, bool tr) -> DM
    qr_solve(SX b, SX v, SX r, SX beta, [int] pinv, bool tr) -> SX
...
def ldl(*args):
    ...
    ldl(IM A) -> (IM OUTPUT1, IM OUTPUT2)
    ldl(DM A) -> (DM OUTPUT1, DM OUTPUT2)
    ldl(SX A) -> (SX OUTPUT1, SX OUTPUT2)
...
class DaeBuilder(PrintableCommon):
    ...
    def add_d(self, *args):
        ...
        > add_d(self, MX new_ddef, str name)
        ------------------------------------------------------------------------
        ...
        > add_d(self, str name, MX new_ddef)
        ------------------------------------------------------------------------
    ...
    def add_y(self, *args):
        ...
        > add_y(self, MX new_ydef, str name)
        ------------------------------------------------------------------------
        ...
        > add_y(self, str name, MX new_ydef)
        ------------------------------------------------------------------------
